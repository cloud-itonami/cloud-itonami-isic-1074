# Operator Quickstart — Macaroni, Noodles, Couscous and Similar Farinaceous Products Coordination

Shortest path from clone to a verified local dry-run for **ISIC 1074** (`cloud-itonami-isic-1074`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-1074.git
cd cloud-itonami-isic-1074
```
...
- Blueprint governor key: `pasta-governor`
- Likely source path: `pastaops.governor.cljc`
